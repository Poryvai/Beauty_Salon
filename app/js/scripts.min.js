...
$(function() {
	...
	$('#my-menu').mmenu({
		...
		offCanvas: {
			//отображение выдвижного списка справа, почему то не работает и надо добавлять в экстеншион поситион райт
			position: 'right'
		}
	});

//open:finish - где финишь это время анимирования, то есть после того как откроется список
//может быть еще after, before
	...
	//PART 10 .1- делаем чтобы равномерные рамки были
	...
	//PART 10
	//решение проблемы с отображением стрелочек упр слайда
...
//делаем последнее слово в заголовке span для того чтобы его можно было редактировать
	...
	$("form.callback").submit(function() { //Change
		...
		$.ajax({
			type: "POST",
			url: "mail.php", //Change / <- касую ставить если указываешь путь /mail.php если в том же проекте то не надо
			data: th.serialize()
		}).done(function() {
...
//PART 14
	...
	//PART 15
	//написали функцию для появление кнопки наверх
	...
	//Указыввем функцию которая будет перемещать пользователя наверх экрана
	$('.top').click(function(){
